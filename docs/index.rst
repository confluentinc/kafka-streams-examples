...
packaged in the fat jar at ``/app/kafka-streams-examples-3.3.1-SNAPSHOT-standalone.jar`` inside this container.
...
.. sourcecode:: bash
    ...
    $ docker-compose exec kafka-music-application \
            java -cp /app/kafka-streams-examples-3.3.1-SNAPSHOT-standalone.jar \
