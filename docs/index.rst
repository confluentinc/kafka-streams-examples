...
packaged in the fat jar at ``/app/kafka-streams-examples-4.0.0-SNAPSHOT-standalone.jar`` inside this container.
...
.. sourcecode:: bash
    ...
    $ docker-compose exec kafka-music-application \
            java -cp /app/kafka-streams-examples-4.0.0-SNAPSHOT-standalone.jar \
