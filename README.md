...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200115214019-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200115214019-standalone.jar \
