...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210102194047-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210102194047-standalone.jar \
