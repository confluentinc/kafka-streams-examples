...
# >>> Creates target/kafka-streams-examples-7.0.0-beta210604105212-cp7-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-7.0.0-beta210604105212-cp7-standalone.jar \
