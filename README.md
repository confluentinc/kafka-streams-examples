...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190817193233-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190817193233-standalone.jar \
