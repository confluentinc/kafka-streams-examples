...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201113193037-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201113193037-standalone.jar \
