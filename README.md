...
# >>> Creates target/kafka-streams-examples-6.1.0-beta201008214913-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta201008214913-standalone.jar \
