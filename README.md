...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190822194627-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190822194627-standalone.jar \
