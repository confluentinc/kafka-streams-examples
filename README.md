...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210103193850-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210103193850-standalone.jar \
