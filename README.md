...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201027200614-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201027200614-standalone.jar \
