...
# >>> Creates target/kafka-streams-examples-5.4.0-beta191018193229-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta191018193229-standalone.jar \
