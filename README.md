...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210209024802-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210209024802-standalone.jar \
