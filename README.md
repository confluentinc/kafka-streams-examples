...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201122193350-cp4-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201122193350-cp4-standalone.jar \
