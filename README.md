...
# >>> Creates target/kafka-streams-examples-6.0.0-beta200501012433-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.0.0-beta200501012433-standalone.jar \
