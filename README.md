...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200130175549-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200130175549-standalone.jar \
