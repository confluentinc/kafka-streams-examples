...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210121113401-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210121113401-standalone.jar \
