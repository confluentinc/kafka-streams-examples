...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201226194921-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201226194921-standalone.jar \
