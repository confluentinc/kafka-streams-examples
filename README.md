...
# >>> Creates target/kafka-streams-examples-5.4.0-beta191001193218-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta191001193218-standalone.jar \
