...
# >>> Creates target/kafka-streams-examples-5.5.0-beta191108014641-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta191108014641-standalone.jar \
