...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190814193933-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190814193933-standalone.jar \
