...
# >>> Creates target/kafka-streams-examples-5.2.3-beta190812232812-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.2.3-beta190812232812-standalone.jar \
