...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210303055943-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210303055943-standalone.jar \
