...
| ----------------------------------------|--------------------|-------------------|
| [5.4.1-post](../../../tree/5.4.1-post/) | 5.4.1              | 2.4.1             |
...
\*You must manually build the `2.4` version of Apache Kafka and the `5.4.x` version of Confluent Platform.  See instructions above.
