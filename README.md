...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190809193509-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190809193509-standalone.jar \
