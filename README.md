...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190925193823-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190925193823-standalone.jar \
