...
# >>> Creates target/kafka-streams-examples-7.0.0-beta210426164707-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-7.0.0-beta210426164707-standalone.jar \
