...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201114192651-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201114192651-standalone.jar \
