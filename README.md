...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210108195459-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210108195459-standalone.jar \
