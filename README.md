...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210119194531-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210119194531-standalone.jar \
