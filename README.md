...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210310224144-cp2-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210310224144-cp2-standalone.jar \
