...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200201174523-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200201174523-standalone.jar \
