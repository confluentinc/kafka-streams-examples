...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210209084603-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210209084603-standalone.jar \
