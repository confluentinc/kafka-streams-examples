...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210109194947-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210109194947-standalone.jar \
