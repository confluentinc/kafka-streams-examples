...
# >>> Creates target/kafka-streams-examples-7.0.0-beta210708204217-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-7.0.0-beta210708204217-standalone.jar \
