...
# >>> Creates target/kafka-streams-examples-6.1.0-beta200909192130-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta200909192130-standalone.jar \
