...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190916193216-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190916193216-standalone.jar \
