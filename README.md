...
# >>> Creates target/kafka-streams-examples-6.0.0-beta200302224310-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.0.0-beta200302224310-standalone.jar \
