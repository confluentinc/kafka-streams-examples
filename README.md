...
# >>> Creates target/kafka-streams-examples-5.2.0-SNAPSHOT-standalone.jar
...
$ java -cp target/kafka-streams-examples-5.2.0-SNAPSHOT-standalone.jar \
...
| ----------------------------------------|-------------------|--------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| [master](../../../tree/master/)         | 2.2.0-SNAPSHOT    | 5.2.0-SNAPSHOT     | You must manually build the `trunk` version of Apache Kafka and the `master` version of Confluent Platform.  See instructions above. |
