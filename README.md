...
# >>> Creates target/kafka-streams-examples-6.2.0-beta211228195051-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta211228195051-standalone.jar \
