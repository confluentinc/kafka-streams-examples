...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200126175007-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200126175007-standalone.jar \
