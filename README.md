...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200128175139-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200128175139-standalone.jar \
