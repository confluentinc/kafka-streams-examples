...
# >>> Creates target/kafka-streams-examples-6.0.0-beta200323195048-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.0.0-beta200323195048-standalone.jar \
