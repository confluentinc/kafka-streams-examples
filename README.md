...
# >>> Creates target/kafka-streams-examples-6.0.0-beta200527181219-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.0.0-beta200527181219-standalone.jar \
