...
# >>> Creates target/kafka-streams-examples-7.0.0-beta210604213545-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-7.0.0-beta210604213545-standalone.jar \
