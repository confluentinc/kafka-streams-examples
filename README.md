...
# >>> Creates target/kafka-streams-examples-5.5.0-beta191104225223-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta191104225223-standalone.jar \
