...
# >>> Creates target/kafka-streams-examples-6.1.0-beta201002044922-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta201002044922-standalone.jar \
