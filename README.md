...
# >>> Creates target/kafka-streams-examples-6.1.0-beta201006192510-cp1-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta201006192510-cp1-standalone.jar \
