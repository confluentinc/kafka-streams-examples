...
# >>> Creates target/kafka-streams-examples-6.1.0-beta201005192028-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta201005192028-standalone.jar \
