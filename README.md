...
# >>> Creates target/kafka-streams-examples-7.0.0-beta210423230724-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-7.0.0-beta210423230724-standalone.jar \
