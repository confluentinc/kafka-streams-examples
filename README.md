...
# >>> Creates target/kafka-streams-examples-5.4.0-beta191009230048-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta191009230048-standalone.jar \
