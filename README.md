...
# >>> Creates target/kafka-streams-examples-6.2.0-beta210114002624-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta210114002624-standalone.jar \
