...
# >>> Creates target/kafka-streams-examples-5.5.0-beta191127154945-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta191127154945-standalone.jar \
