...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190812193234-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190812193234-standalone.jar \
