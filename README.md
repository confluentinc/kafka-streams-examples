...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201126193631-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201126193631-standalone.jar \
