...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201127193404-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201127193404-standalone.jar \
