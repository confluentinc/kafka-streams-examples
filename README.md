...
# >>> Creates target/kafka-streams-examples-5.5.0-beta191116174304-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta191116174304-standalone.jar \
