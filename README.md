...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190813193703-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190813193703-standalone.jar \
