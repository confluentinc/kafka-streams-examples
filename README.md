...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190821193309-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190821193309-standalone.jar \
