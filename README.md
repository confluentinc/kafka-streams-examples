...
# >>> Creates target/kafka-streams-examples-6.2.0-beta201118225842-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.2.0-beta201118225842-standalone.jar \
