...
# >>> Creates target/kafka-streams-examples-5.4.0-beta190807193222-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.4.0-beta190807193222-standalone.jar \
