...
# >>> Creates target/kafka-streams-examples-5.5.0-beta200124174837-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-5.5.0-beta200124174837-standalone.jar \
