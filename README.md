...
# >>> Creates target/kafka-streams-examples-6.1.0-beta200720085705-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta200720085705-standalone.jar \
