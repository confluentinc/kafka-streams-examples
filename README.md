...
# >>> Creates target/kafka-streams-examples-6.1.0-beta201007223041-standalone.jar
```
...
$ java -cp target/kafka-streams-examples-6.1.0-beta201007223041-standalone.jar \
