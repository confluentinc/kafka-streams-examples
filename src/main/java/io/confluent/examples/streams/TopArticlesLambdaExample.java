 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210708204217-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210708204217-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
