 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.2.2-cp2-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.2.2-cp2-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
