 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.3-SNAPSHOT-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.3-SNAPSHOT-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
