 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-8.2.0-cp1-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-8.2.0-cp1-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
