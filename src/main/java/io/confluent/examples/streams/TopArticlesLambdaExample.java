 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.0-beta191201173344-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.5.0-beta191201173344-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
