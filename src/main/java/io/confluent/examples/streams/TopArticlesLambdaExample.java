 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.15-SNAPSHOT-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.0.15-SNAPSHOT-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
