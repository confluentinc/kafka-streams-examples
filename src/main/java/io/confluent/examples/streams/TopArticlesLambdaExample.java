 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210310224144-cp3-standalone.jar io.confluent.examples.streams.TopArticlesLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210310224144-cp3-standalone.jar io.confluent.examples.streams.TopArticlesExampleDriver
 * }
 * </pre>
 */
