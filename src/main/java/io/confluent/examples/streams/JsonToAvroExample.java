 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-8.0.1-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-8.0.1-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
