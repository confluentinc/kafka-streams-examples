 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.11-0-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.0.11-0-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
