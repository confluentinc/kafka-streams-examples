 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta201130194630-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-beta201130194630-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
