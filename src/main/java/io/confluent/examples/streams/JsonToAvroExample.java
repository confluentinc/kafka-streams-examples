 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.5.5-0-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.5.5-0-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
