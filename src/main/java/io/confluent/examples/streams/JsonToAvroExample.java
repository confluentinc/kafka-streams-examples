 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.3-cp2-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.3-cp2-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
