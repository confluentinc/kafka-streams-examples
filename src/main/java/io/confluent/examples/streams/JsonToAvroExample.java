 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.2.6-standalone.jar io.confluent.examples.streams.JsonToAvroExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.2.6-standalone.jar io.confluent.examples.streams.JsonToAvroExampleDriver
 * }
 * </pre>
 */
