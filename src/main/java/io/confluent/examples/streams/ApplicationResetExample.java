 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210423230724-cp1-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210423230724-cp1-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
