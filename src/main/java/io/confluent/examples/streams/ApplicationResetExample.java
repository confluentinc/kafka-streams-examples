 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-beta200511191923-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-beta200511191923-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
