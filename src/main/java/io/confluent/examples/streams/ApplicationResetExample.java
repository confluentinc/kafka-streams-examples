 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.7.10-0-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.7.10-0-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
