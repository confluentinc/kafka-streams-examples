 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.1-cp12-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.1-cp12-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
