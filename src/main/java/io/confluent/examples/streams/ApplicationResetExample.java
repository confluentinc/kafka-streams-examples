 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-beta201001232738-standalone.jar io.confluent.examples.streams.ApplicationResetExample
 * }
 * </pre>
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-beta201001232738-standalone.jar io.confluent.examples.streams.ApplicationResetExample localhost:9092 --reset
 * }</pre>
