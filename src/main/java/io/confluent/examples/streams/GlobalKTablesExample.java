 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210210003100-cp1-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210210003100-cp1-standalone.jar io.confluent.examples.streams.GlobalKTablesExampleDriver
 * }
 * </pre>
 * <p>
