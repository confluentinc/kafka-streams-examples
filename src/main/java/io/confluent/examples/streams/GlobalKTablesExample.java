 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.10-SNAPSHOT-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-6.0.10-SNAPSHOT-standalone.jar io.confluent.examples.streams.GlobalKTablesAndStoresExampleDriver
 * }
 * </pre>
 * <p>
