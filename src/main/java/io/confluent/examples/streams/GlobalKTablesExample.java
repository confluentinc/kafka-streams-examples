 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-cp1-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-6.1.0-cp1-standalone.jar io.confluent.examples.streams.GlobalKTablesAndStoresExampleDriver
 * }
 * </pre>
 * <p>
