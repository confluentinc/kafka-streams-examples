 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.0-beta191015194035-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.0-beta191015194035-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
