 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.2-SNAPSHOT-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.2-SNAPSHOT-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
