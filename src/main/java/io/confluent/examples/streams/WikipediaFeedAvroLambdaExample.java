 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-beta200822191028-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.1.0-beta200822191028-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
