 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.2.3-beta190812232812-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.2.3-beta190812232812-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
