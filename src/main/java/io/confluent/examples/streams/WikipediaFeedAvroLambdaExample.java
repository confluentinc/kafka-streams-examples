 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210422040511-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210422040511-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
