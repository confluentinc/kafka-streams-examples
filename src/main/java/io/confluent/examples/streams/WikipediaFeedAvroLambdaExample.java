 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210210003100-cp3-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210210003100-cp3-standalone.jar io.confluent.examples.streams.WikipediaFeedAvroExampleDriver
 * }
 * </pre>
 */
