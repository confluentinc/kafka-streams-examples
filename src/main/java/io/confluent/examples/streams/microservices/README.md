...
**Try [the quickstart](https://github.com/confluentinc/quickstart-demos/blob/5.0.1-cp3-post/microservices-orders/README.md) which runs the ecosystem for you including Kafka Connect, Elasticsearch, KSQL and Control Centre**
---
...
The best place to start is [EndToEndTest.java](https://github.com/confluentinc/kafka-streams-examples/blob/5.0.1-cp3-post/src/test/java/io/confluent/examples/streams/microservices/EndToEndTest.java)
