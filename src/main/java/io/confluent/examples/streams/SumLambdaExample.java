 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.1.5-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.1.5-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
