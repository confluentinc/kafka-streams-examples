 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.13-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.5.13-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
