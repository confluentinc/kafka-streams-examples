 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-cp1-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.0.0-cp1-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
