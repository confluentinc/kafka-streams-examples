 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.2-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.0.2-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
