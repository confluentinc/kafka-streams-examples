 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-3.3.1-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }</pre>
 ...
 * $ java -cp target/kafka-streams-examples-3.3.1-SNAPSHOT-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }</pre>
