 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.7-0-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.7-0-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
