 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-4.1.5-SNAPSHOT-standalone.jar io.confluent.examples.streams.interactivequeries.WordCountInteractiveQueriesDriver
 * }
 * </pre>
