 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.3.8-SNAPSHOT-standalone.jar io.confluent.examples.streams.interactivequeries.WordCountInteractiveQueriesDriver
 * }
 * </pre>
