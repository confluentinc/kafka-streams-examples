 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.0-beta191026175117-standalone.jar io.confluent.examples.streams.interactivequeries.WordCountInteractiveQueriesDriver
 * }
 * </pre>
