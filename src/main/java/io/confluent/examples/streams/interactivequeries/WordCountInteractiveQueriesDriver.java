 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.0.0-beta210604105212-standalone.jar io.confluent.examples.streams.interactivequeries.WordCountInteractiveQueriesDriver
 * }
 * </pre>
