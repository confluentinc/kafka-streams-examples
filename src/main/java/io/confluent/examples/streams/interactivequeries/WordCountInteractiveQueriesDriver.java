 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-beta200624225114-standalone.jar io.confluent.examples.streams.interactivequeries.WordCountInteractiveQueriesDriver
 * }
 * </pre>
