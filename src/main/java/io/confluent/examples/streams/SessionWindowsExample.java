 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210310224144-cp5-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210310224144-cp5-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
