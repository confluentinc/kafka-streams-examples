 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.7-SNAPSHOT-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.5.7-SNAPSHOT-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
