 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.0-beta191026062717-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.0-beta191026062717-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
