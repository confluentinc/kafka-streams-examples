 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.2-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.2-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
