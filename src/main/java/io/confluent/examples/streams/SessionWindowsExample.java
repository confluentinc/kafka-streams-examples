 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-8.2.0-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-8.2.0-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
