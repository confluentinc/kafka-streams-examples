 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.8.3-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.8.3-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
