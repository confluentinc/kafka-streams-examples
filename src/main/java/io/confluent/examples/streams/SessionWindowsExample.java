 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.1.0-beta201005192028-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.1.0-beta201005192028-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
