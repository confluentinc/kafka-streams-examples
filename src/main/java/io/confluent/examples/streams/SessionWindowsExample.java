 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-4.1.1-cp6-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-4.1.1-cp6-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
