 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.2.12-0-standalone.jar io.confluent.examples.streams.SessionWindowsExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.2.12-0-standalone.jar io.confluent.examples.streams.SessionWindowsExampleDriver
 * }
 * </pre>
