 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.4.2-cp3-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.4.2-cp3-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
