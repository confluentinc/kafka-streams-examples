 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.4.4-0-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.4.4-0-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
