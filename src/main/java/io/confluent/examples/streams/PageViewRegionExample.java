 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.1-cp12-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.5.1-cp12-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
