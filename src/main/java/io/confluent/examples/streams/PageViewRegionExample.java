 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.5.0-cp1-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.5.0-cp1-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
