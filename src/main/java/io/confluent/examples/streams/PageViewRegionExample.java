 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210101194759-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-6.2.0-beta210101194759-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
