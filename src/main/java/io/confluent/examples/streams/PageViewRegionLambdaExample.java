 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.9.5-cp2-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.9.5-cp2-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
