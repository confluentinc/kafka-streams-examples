 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-8.2.2-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-8.2.2-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
