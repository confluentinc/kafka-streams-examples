 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-7.9.0-standalone.jar io.confluent.examples.streams.PageViewRegionLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-7.9.0-standalone.jar io.confluent.examples.streams.PageViewRegionExampleDriver
 * }
 * </pre>
