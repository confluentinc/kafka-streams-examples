...
public class StreamToStreamJoinIntegrationTest {
  ...
  public void shouldJoinTwoStreams() throws Exception {
    ...
    final KStream<String, String> alerts = builder.stream(stringSerde, stringSerde, adImpressionsTopic);
    final KStream<String, String> incidents = builder.stream(stringSerde, stringSerde, adClicksTopic);
    ...
    final List<KeyValue<String, String>> actualResults =
      IntegrationTestUtils.waitUntilMinKeyValueRecordsReceived(consumerConfig, outputTopic, expectedResults.size());
    streams.close();
