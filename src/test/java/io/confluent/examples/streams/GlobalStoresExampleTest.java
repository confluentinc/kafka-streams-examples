...
public class GlobalStoresExampleTest {
    ...
    public void createStreams() {
        ...
        streamInstanceOne =
                GlobalStoresExample.createStreams(CLUSTER.bootstrapServers(),
    ...
    public void shouldDemonstrateGlobalStoreJoins() throws Exception {
        ...
        consumerProps.put(ConsumerConfig.GROUP_ID_CONFIG, "global-stores-consumer");
